...
class ExampleDSLListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ExampleDSLParser#is_hint.
    def enterIs_hint(self, ctx:ExampleDSLParser.Is_hintContext):
        pass

    # Exit a parse tree produced by ExampleDSLParser#is_hint.
    def exitIs_hint(self, ctx:ExampleDSLParser.Is_hintContext):
        pass
