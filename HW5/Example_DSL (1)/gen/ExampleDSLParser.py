# Generated from D:/1402 - 2/compiler/Assignment/compiler/HW5/Example_DSL (1)/grammar/ExampleDSL.g4 by ANTLR 4.13.1
# encoding: utf-8
from antlr4 import *
...
def serializedATN():
    return [
        ...
        0,27,28,5,0,0,1,28,1,1,0,0,0,29,31,3,8,4,0,30,29,1,0,0,0,30,31,1,
        0,0,0,31,33,1,0,0,0,32,34,3,4,2,0,33,32,1,0,0,0,33,34,1,0,0,0,34,
...
class ExampleDSLParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'hint:'", "'False'", "'True'", "'output:'", 
                     "'html'", "'console'", "'game:'", "'X'", "'bomb:'", 
                     "','" ]
    ...
    ruleNames =  [ "start", "program", "hint", "is_hint", "output", "output_types", 
                   "initiate_game", "width", "height", "bomb_placements", 
    ...
    class HintContext(ParserRuleContext):
        ...
        def is_hint(self):
            return self.getTypedRuleContext(ExampleDSLParser.Is_hintContext,0)
    ...
    def hint(self):
        ...
        self.enterRule(localctx, 4, self.RULE_hint)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 38
    ...
    class Is_hintContext(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def getRuleIndex(self):
            return ExampleDSLParser.RULE_is_hint

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterIs_hint" ):
                listener.enterIs_hint(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitIs_hint" ):
                listener.exitIs_hint(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitIs_hint" ):
                return visitor.visitIs_hint(self)
            else:
                return visitor.visitChildren(self)
    ...
    def is_hint(self):
        ...
        localctx = ExampleDSLParser.Is_hintContext(self, self._ctx, self.state)
        self.enterRule(localctx, 6, self.RULE_is_hint)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 41
    ...
    def output_types(self):
        ...
        self.enterRule(localctx, 10, self.RULE_output_types)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 46
